"""
Django settings for EduAidNepal project.
...
ALLOWED_HOSTS = ["127.0.0.1", "newnapa.pythonanywhere.com"]
...
WSGI_APPLICATION = "EduAidNepal.wsgi.application"
...
REST_FRAMEWORK = {
    ...
    # This shows the data into json format
...
STATIC_ROOT = os.path.join(BASE_DIR, "static")  # to join all the static files
...
EMAIL_USER = 'napaofficial7@gmail.com'
EMAIL_PASS = '1234'
